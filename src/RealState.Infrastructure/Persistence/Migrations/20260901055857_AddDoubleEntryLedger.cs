        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubKind = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    SubRefId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_TenantId_SubKind_SubRefId",
                table: "Accounts",
                columns: new[] { "TenantId", "SubKind", "SubRefId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_TenantId_Number",
                table: "JournalEntries",
